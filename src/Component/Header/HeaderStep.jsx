    ...
    return (
        ...
        <div className="max-w-7xl mx-auto w-full flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex justify-between items-center gap-4 sm:gap-10 w-full sm:w-auto">
            <Link to="/">
            <img
              src="https://llerasparkconcepthotel.com/wp-content/uploads/2025/02/logo-lleras-park-concept-hotel-medellin.png"
              alt="Logo"
          ...
          <div className="md:hidden block">
            {steps
                ...
                >
                    <span className="rounded-full w-5 h-5 text-xs flex items-center justify-center bg-black text-white">
                    {step}
                    </span>
                    {label}
                </div>
